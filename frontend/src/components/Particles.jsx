...
const vertex = /* glsl */ `
  ...
  void main() {
    ...
    if (uSizeRandomness == 0.0) {
      ...
      // Adjust point size based on distance for perspective
      gl_PointSize = (uBaseSize * (1.0 + uSizeRandomness * (random.x - 0.5))) / -mvPos.z; // Use -mvPos.z for perspective scaling
    }
